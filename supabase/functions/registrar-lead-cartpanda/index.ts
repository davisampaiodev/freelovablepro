...
const FUNCTION_NAME = "registrar-lead-cartpanda";
const LOG_PREFIX = "REGISTER_CARTPANDA_LEAD_RESULT";
const PROVIDER = "cartpanda";
...
function allowedOrigins() {
  const configured = env("CARTPANDA_ALLOWED_ORIGINS")
    .split(",")
...
serve(async (request: Request) => {
  ...
  const externalReference = `cartpanda_${sessionId}`;
